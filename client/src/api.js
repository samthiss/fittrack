...
export const api = {
  ...
  getFoodDuplicates: () => request('/foods/duplicates'),
  mergeFoods: (keepId, removeIds) =>
    request('/foods/merge', { method: 'POST', body: JSON.stringify({ keep_id: keepId, remove_ids: removeIds }) }),
